...
╱╱╱╱╱╱╱╱╱╱╱╰━╯                                              
\033[1;96m-----------------------------------------------
\033[1;93m➣ OWNER   : AROOJ KHAN X MALANG JAAN
\033[1;93m➣ Github  : https://github.com/
\033[1;93m➣   FB    : AROOJ KHA 
\033[1;93m➣ Youtube : ALL FB TRICKS
\033[1;93m➣ WhatsApp: +000971
\033[1;96m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def men():
	...
	if rana =="":
		...
		os.system('xdg-open https://https://www.facebook.com/zidi.gujjar.16568
		menu()
	elif rana =="7":
		os.system('rm -rf login.txt')
...
def crack_menu():
	...
	if crm =="":
		...
		try:
			...
			hamza('\033[1;95m[✓] Account Name \033[1;97m:\033[1;95m '+op['name'])
		except KeyError:
			print"[!] ID Not Found!"
			raw_input("\nPress Enter To Back  ")
			crack()
